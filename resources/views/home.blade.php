        ...
        <nav class="navbar navbar-dark navbar-expand-lg bg-primary">
            <div class="container flex justify-content-between">
              <a class="navbar-link" href="{{route('home')}}">
                <img class="h-32px" src="{{url("assets/images/logo_white.png")}}" alt="Laracuss logo">
              </a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-0 mx-lg-3">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#">Disscusions</a>
                  </li>
                  <li class="nav-item" >
                    <a class="nav-link text-nowrap" aria-current="page" href="#">About Us</a>
                  </li>
                </ul>
                <form class="d-flex w-100 me-4 my-2 my-1g-0" role="search" action="" method="GET">
                  <div class="input-group">
                    <span class="input-group-text bg-white border-end-0"><img src="{{url("assets/images/magnifiar.png")}}" alt="search">
                    </span>
          ...
          <section class="container hero">
            <div class="row align-items-center h-100">
              <div class="col-12 col-lg-6">
                ...
                <a href="#" class="btn btn-secondary mb-2 mb-lg-0">Join Disscusions</a>
              </div>
              ...
              <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                  <div class="card">
                    ...
                    <div>
                      <p class="mb-5">
                        I am working on a blogging aplication in laravel 8. There are 4 under roles, among which, thef
                      </p>
                      <div class="row">
                        ...
                        <div class="col-5 col-lg-7">
                          <div class="avatar-sm-wrapper d-inline-block">
                            <a href="#" class = "me-1">
                              <img src="{{url("assets/images/magnifiar.png")}}" class="avatar rounded-circle" alt="">
                            </a>
                          </div>
                          <span class="fs-12px" >
            ...
            <div class="container">
              <div class="row">
                <div class="col-12 col-lg-6 mb-5 mb-lg-0">
                  <img src="{{url("assets/images/logo_white.png")}}" alt="Laracuss logo" class="h-32px mb-4">
                  <p class="text-white">Empowering laravel community</br>to connect. share and learn.</p>
                </div>
                <div<div class="col-12 col-lg-6 me-auto">
                  <div class="d-flex flex-column flex-lg-row justify-content-end">
                    <div class="d-flex flex-column me-140px mb-3 mb-lg-0">
                      ...
                      <ul class="list-unstyled">
                          <li class="text-white">
                            <a href="mailto:hi@laracuss.com">hi@laracuss.com</a>
                          </li>
                      </ul>
                    </div>
